...
export const BiometricAnimation = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-gray-900 rounded-2xl border-2 border-purple-500 max-w-md mx-4 p-8 text-center">
        {/* Círculos pulsantes */}
...
export const SuccessAnimation = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm p-4">
      <div className={`bg-gray-900 rounded-2xl border-2 border-purple-500 max-w-md mx-4 p-8 text-center transition-all duration-500 ${show ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}>
        {/* Confetti effect */}
